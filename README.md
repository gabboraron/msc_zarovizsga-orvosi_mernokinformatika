...
> Analitikus módszerek kategoriális változó vizsgálatára: gyakorisági sor, gyakoriság, relatív gyakoriság, [módusz](https://www.mateking.hu/valoszinusegszamitas/statisztikai-alapfogalmak/modusz-es-median). Grafikus módszer kategoriális változó vizsgálatára: oszlop- és kördiagram. Két kategoriális változó egyidejű vizsgálata, kereszttábla.
