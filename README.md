...
> 1. A röntgen alapú képalkotás
> 2. A röntgen vizsgálat előnyei, hátrányai
> 3. Röntgen alapú vizsgálati megoldások
> 4. A röntgen berendezés általános belső működése
> 5. A röntgen alapú képalkotás problémái

### [II. CT - Computer Tomography](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#computer-tomogr%C3%A1fia-ct)
> 1. A CT alapú képalkotás
> 2. A CT vizsgálat előnyei, hátrányai, backprojection
> 3. A CT alapú vizsgálati megoldások
> 4. A CT berendezés általános belső működése
> 5. A CT fejlődésének főbb állomásai, a CT alapú képalkotás problémái

### [III. OCT - Optical Coherence Tomography](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#oct)
> 1. Az OCT alapú képalkotás (TD-OCT, és SD-OCT)
> 2. Az OCT vizsgálat előnyei, hátrányai
> 3. Az OCT alapú vizsgálati megoldások
> 4. Az OCT berendezés általános belső működése
> 5. Az OCT fejlődésének főbb állomásai, az OCT alapú képalkotás problémái

### [IV.MRI - Magnetic Resonance Imaging](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#mri)
> 1. A MRI alapú képalkotás
> 2. A MRI vizsgálat előnyei, hátrányai
> 3. A MRI alapú vizsgálati megoldások
> 4. A MRI berendezés általános belső működése
> 5. A MRI fejlődésének főbb állomásai, az MRI alapú képalkotás problémái

### [V. PET - PET Positron Emission Tomography](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#pet)
> 1. A PET alapú képalkotás
> 2. A PET vizsgálat előnyei, hátrányai
> 3. A PET alapú vizsgálati megoldások
> 4. A PET berendezés általános belső működése
> 5. A PET fejlődésének főbb állomásai, a PET alapú képalkotás problémái

### [VI. Spektroszkópia/spektrometria](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#vispektroszk%C3%B3piaspektrometria)
...
> 5. A spektroszkóp/spektrométer berendezések általános belső működése

### [VII. CTI - Computerised Thermal Imaging](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#viicti---computerised-thermal-imaging)
...
### [IX. Képalkotás optikai tartományban](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#optika-mikroszk%C3%B3pia)
...
### [X. Nagyfelbontású (fény)mikroszkópia I.](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#nagyfelbont%C3%A1s%C3%BA-f%C3%A9nymikroszk%C3%B3pia-i)
> 1. Airy minta
...
### [XI. Nagyfelbontású (fény)mikroszkópia II.](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#nagyfelbont%C3%A1s%C3%BA-f%C3%A9nymikroszk%C3%B3pia-ii)
> 1. Huygens-Fresnel elv
> 2. A fluoreszcens mikroszkóp részei, elrendezése, működése
> 3. Az fluoreszcens mikroszkóp jellemzői, előnyei/hátrányai
> 4. A sötétlátóteres (darkfield) mikroszkóp részei, elrendezése, működése
> 5. A sötétlátóteres (darkfield) mikroszkóp jellemzői, előnyei/hátrányai

### [XII. Digitális mikroszkópia](https://github.com/gabboraron/diagnosztikai_celu_orvosi_kepalkotas#digit%C3%A1lis-mikroszk%C3%B3pia-iii)
...
- [egy lapon](https://github.com/gabboraron/msc_zarovizsga-orvosi_mernokinformatika/tree/main/biostatisztika_osszegzo_jegyzet)
...
> [Analitikus módszerek kategoriális változó vizsgálatára](https://docplayer.hu/19936206-4-induktiv-statisztika-16-4-1-a-mintaveteli-helyzet-konzekvenciai-16-4-2-becsleselmelet-17-4-3-hipotezisvizsgalat-20.html): gyakorisági sor, gyakoriság, relatív gyakoriság, [módusz](https://www.mateking.hu/valoszinusegszamitas/statisztikai-alapfogalmak/modusz-es-median). Grafikus módszer kategoriális változó vizsgálatára: oszlop- és kördiagram. Két kategoriális változó egyidejű vizsgálata, kereszttábla.
- https://e-akademia.hu/html/zold12/ch-statalap.html#ch:leiro-es-induktiv
### 4.	Deskriptív statisztika: folytonos változó(k) vizsgálata
> Analitikus módszerek folytonos változó vizsgálatára: átlag, medián, terjedelem, [szórás](http://www.medstat.hu/targyak/BevEuMkBiostatisztikaSlides.pdf#134), IQR, kvantilisek. Grafikus módszer folytonos változó vizsgálatára: hisztogram, magfüggvényes sűrűségbecslés, Tukey-féle boxplot. Két folytonos változó együttes vizsgálata: kovariancia, korreláció, szóródási diagram.
...
> A becsléselmélet alapjai: becslőfüggvény, a becslőfüggvény mintavételi tulajdonságai (torzítatlanság, hatásosság, konzisztencia stb.). Pontbecslés és intervallumbecslés ([konfidenciaintervallum](https://www.mateking.hu/analizis-3/becslesek/becsles-konfidencia-szint-konfidencia-intervallum)). A mintanagyság szerepe és jelentősége, mintanagyság-tervezés.
...
> A hipotézisvizsgálat alapfogalmai, null- és ellenhipotézis, tesztstatisztika. A hipotézisvizsgálat logikája. Első- és másodfajú hiba. Döntés hipotézisvizsgálatban: [szignifikanciaszint](https://www.mateking.hu/statisztika/hipotezisvizsgalat/elfogadasi-tartomany-kritikus-tartomany-szignifikanciaszint), kritikus érték, p-érték. Egy- és kétoldalú próbák. Próba választása adott kérdés vizsgálatára.
